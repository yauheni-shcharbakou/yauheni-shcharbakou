...
6 microservices shipped solo · API latency cut 10-15x · 2 card-provider integrations
...
On my current FinTech platform I am the sole backend engineer - 6 microservices, card-provider integrations, and the auth layer, all designed and built from scratch.

## Selected Work

- **Architected 6 microservices from scratch** as the sole backend engineer on a FinTech/Web3 platform - event-driven on NestJS + Kafka, with independent scaling and isolated business logic.
...
- **Integrated 2 card-issuing providers** (Payca, Webscard) through their REST APIs, expanding the platform's payment capabilities.
